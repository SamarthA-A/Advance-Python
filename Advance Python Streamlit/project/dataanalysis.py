...
filtered_edu = df_filtered.groupby(by=["Education_level"])[["Motivation_to_deep_thinking"]].mean().sort_values(by="Motivation_to_deep_thinking")
...
problem_filtered = df_filtered.groupby(by=["Age"])[["problem_solving_approach"]].mean()
